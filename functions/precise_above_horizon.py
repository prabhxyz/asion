...
def above_horizon(constellation_name, latitude, longitude, height, time, i, b_num, max_altitude, min_altitude, max_azimuth, min_azimuth):
    ...
    if (max_altitude >= constellation_altaz.alt.deg >= min_altitude) and (max_azimuth >= constellation_altaz.az.deg >= min_azimuth):
        return True
    else:
        return False
