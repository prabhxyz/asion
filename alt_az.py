...
def get_alt_az(constellation_name: str, longitude: float, latitude: float, year: str, month: str, day: str, hour: str, minute: str, second: str, i: int):
    # Observer's location
    ...
    sys.stdout.write('\r' + f"Loading... {(i / 360) * 100}%")
